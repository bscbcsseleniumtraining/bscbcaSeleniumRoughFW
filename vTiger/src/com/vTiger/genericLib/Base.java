...
public class Base 
{
	...
	public void configBC()
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "./src/com/vTiger/resources/chromedriver.exe");
			driver = new ChromeDriver();
			scrnDriver = driver;
		}
		else if(flib.getPropertyKeyValue("browser").equals("firefox"))
		{
			System.setProperty("webdriver.gecko.driver", "./src/com/vTiger/resources/geckodriver.exe");
			driver = new FirefoxDriver();
			scrnDriver = driver;
		}
		else
		{
			System.setProperty("webdriver.ie.driver", "./src/com/vTiger/resources/IEDriverServer.exe");
