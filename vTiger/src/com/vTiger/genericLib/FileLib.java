...
/**
 * This class contains all generic methods like reading data from Excel and Properties file
 * @author Manjunath
 *
 */
...
public class FileLib 
{
	...
	public String getPropertyKeyValue(String key)
	{
		...
		try
		{
			ip = new FileInputStream("./src/com/vTiger/testData/commonData.properties");
			prop = new Properties();
			prop.load(ip);
		}
		catch(Exception e)
	...
	public String getExcelData(String sheetName, int rowNum, int cellNum)
	{
		...
		try
		{
			ip = new FileInputStream("./src/com/vTiger/testData/testData.xlsx");
